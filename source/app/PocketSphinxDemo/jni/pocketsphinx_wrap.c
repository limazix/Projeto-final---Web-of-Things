...
SWIGINTERN SegmentIterator *new_SegmentIterator(Decoder *d){
		int32 score;
		SegmentIterator *si = ps_seg_iter(d, &score);
		return si;
	}
SWIGINTERN char const *SegmentIterator_getWord(SegmentIterator *self){
		return ps_seg_word(self);
	}
SWIGINTERN SegmentIterator *SegmentIterator_getNext(SegmentIterator *self){
...
SWIGEXPORT jlong JNICALL Java_edu_cmu_pocketsphinx_pocketsphinxJNI_new_1SegmentIterator(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
...
SWIGEXPORT jstring JNICALL Java_edu_cmu_pocketsphinx_pocketsphinxJNI_SegmentIterator_1getWord(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jstring jresult = 0 ;
  ...
  result = (char *)SegmentIterator_getWord(arg1);
  if (result) jresult = (*jenv)->NewStringUTF(jenv, (const char *)result);
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_edu_cmu_pocketsphinx_pocketsphinxJNI_SegmentIterator_1getNext(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  SegmentIterator *arg1 = (SegmentIterator *) 0 ;
  SegmentIterator *result = 0 ;
  ...
  (void)jarg1_;
  arg1 = *(SegmentIterator **)&jarg1; 
  result = (SegmentIterator *)SegmentIterator_getNext(arg1);
  *(SegmentIterator **)&jresult = result; 
  return jresult;
}
